...
#define POWER_IOB_ON()          (P1OUT |= BIT2)
#define POWER_IOB_OFF()         (P1OUT &= ~BIT2)

#define GPRS_TIMEOUT_TIME_PER   (1000)    //*< gprs超时的最小粒度

#define GPRS_TASK_PRIO       (4u)//4

typedef enum
{
    GPRS_SEND_EVENT = ((GPRS_TASK_PRIO<<8) | 0x01),
    GPRS_SEND_CMD_EVENT,
    GPRS_RESPONSE_EVENT,
    GPRS_SWITCH_EVENT,
    GPRS_SET_MODE,
    STOP_GPRS_DELAY_TIMER,   
    GPRS_CMD_CIPSTART_RECV_EVENT,
    
//#ifdef USE_GPRS_M26 
//    GPRS_CMD_QIOPEN_RECV_EVENT,
//#endif
    GPRS_FLUSH_RECV_BUF_EVENT,
    GPRS_STATE_TRANS_EVENT,
    GPRS_UART_EVENT,
    GPRS_TIMEOUT_EVENT,
    GPRS_NO_DATA_EVENT,
    GPRS_SEND_DATA_ERROR_EVENT,
