...
extern gprs_data_type_t gprs_data_recv_from_app_last;
...
static void gprs_cmd_data_recv_handler(void)
{
    ...
    gprs_data_recv_from_app_last.gprs_data_mode = data_mode_temp;
...
void gprs_uart_event_handler(void)
{
    ...
    else
    {
         ...
         case GPRS_CMD_AT:
             ...
             DBG_LOG(DBG_LEVEL_INFO, "GPRS_CMD_AT\n");
             break;
         
         case GPRS_CMD_ATE0:
             gprs_cmd_ate0_recv_handler();
             DBG_LOG(DBG_LEVEL_INFO, "GPRS_CMD_ATE0\n");
             break;
         
         case GPRS_CMD_CGATT:
             gprs_cmd_cgatt_recv_handler();
             DBG_LOG(DBG_LEVEL_INFO, "GPRS_CMD_CGATT\n");
             break;
         
         case GPRS_CMD_CIPSTART:
             gprs_cmd_cipstart_recv_handler();
             DBG_LOG(DBG_LEVEL_INFO, "GPRS_CMD_CIPSTART\n");
             break;
