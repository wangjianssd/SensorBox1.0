...
/*以下是协议相关配置*/
/******************************************************************************/
#define NODE_TYPE_DETECTOR              0x01
#define NODE_TYPE_ROUTER                0x02
#define NODE_TYPE_HOST                  0x03
#define NODE_TYPE_COLLECTOR				0x04
#define NODE_TYPE_EXPANSION				0x05

#define NODE_TYPE                       (NODE_TYPE_COLLECTOR)
/******************************************************************************/
...
/******************************************************************************/
#define MAX_TOPU_SIZE		            (400u)	// 拓扑数组的最大维度
#define MAX_TOPU_SURVIVAL_TIME	        (5u)	// 最大存活时间
...
#define DEBUG_SSN_INFO_EN		        (1u)	// 是否配置SSN网络基础信息
