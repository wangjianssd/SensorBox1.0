...
// INPUT DATA
/*
// Crys_freq(Hz): 32000000    Crys_tol(ppm): 20    IF_mode: 2    High_perf_Ch_Fil: 1    OSRtune: 0    Ch_Fil_Bw_AFC: 0    ANT_DIV: 0    PM_pattern: 0    
// MOD_type: 2    Rsymb(sps): 100000    Fdev(Hz): 100000    RXBW(Hz): 150000    Manchester: 0    AFC_en: 1    Rsymb_error: 0.0    Chip-Version: 2    
// RF Freq.(MHz): 475    API_TC: 29    fhst: 200000    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
// 
// # RX IF frequency is  -500000 Hz
// # WB filter 1 (BW = 325.58 kHz);  NB-filter 1 (BW = 325.58 kHz)
// 
// Modulation index: 2
*/
...
*/
#define RF_GPIO_PIN_CFG 0x13, 0x13, 0x14, 0x00, 0x00, 0x27, 0x0B, 0x00
...
*/
#define RF_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x05, 0x0C, 0x00, 0x0F, 0x12, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_PKT_CRC_CONFIG_7 0x11, 0x12, 0x07, 0x00, 0x04, 0x01, 0x08, 0xFF, 0xFF, 0x00, 0x02
...
*/
#define RF_PKT_LEN_12 0x11, 0x12, 0x0C, 0x08, 0x23, 0x02, 0x00, 0x30, 0x30, 0x00, 0x02, 0x04, 0x80, 0x00, 0x01, 0x00
...
*/
#define RF_PKT_FIELD_2_CRC_CONFIG_12 0x11, 0x12, 0x0C, 0x14, 0x00, 0x00, 0x3D, 0x00, 0x2A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x02, 0x00, 0x07, 0x0F, 0x42, 0x40, 0x01, 0xE8, 0x48, 0x00, 0x00, 0x19
...
*/
#define RF_MODEM_FREQ_DEV_0_1 0x11, 0x20, 0x01, 0x0C, 0x9A
...
*/
#define RF_MODEM_BCR_OSR_1_9 0x11, 0x20, 0x09, 0x22, 0x00, 0x6B, 0x04, 0xCC, 0xCD, 0x02, 0x64, 0x02, 0xC2
...
*/
#define RF_MODEM_AFC_GEAR_7 0x11, 0x20, 0x07, 0x2C, 0x04, 0x47, 0x82, 0x22, 0x02, 0xCA, 0x80
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_9 0x11, 0x20, 0x09, 0x38, 0x11, 0x17, 0x17, 0x00, 0x02, 0x80, 0x00, 0x00, 0x28
...
*/
#define RF_MODEM_OOK_CNT1_9 0x11, 0x20, 0x09, 0x42, 0xA4, 0x02, 0xD6, 0x83, 0x02, 0x57, 0x01, 0x80, 0x0F
...
*/
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x39, 0x0E, 0x00, 0x00, 0x33, 0x33, 0x20, 0xFE
